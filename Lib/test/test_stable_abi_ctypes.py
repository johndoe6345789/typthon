...
SYMBOL_NAMES = (
    ...
    "Ty_EncodeLocale",
    "Ty_EndInterpreter",
    "Ty_EnterRecursiveCall",
    "Ty_Exit",
    "Ty_FatalError",
    "Ty_FileSystemDefaultEncodeErrors",
    "Ty_FileSystemDefaultEncoding",
    "Ty_Finalize",
    "Ty_FinalizeEx",
    "Ty_GenericAlias",
    "Ty_GenericAliasType",
    ...
    "Ty_GetProgramName",
    "Ty_GetPythonHome",
    "Ty_GetRecursionLimit",
    "Ty_GetVersion",
    "Ty_HasFileSystemDefaultEncoding",
    "Ty_IncRef",
    "Ty_Initialize",
    "Ty_InitializeEx",
    "Ty_Is",
    ...
    "_PyWeakref_RefType",
    "_Ty_BuildValue_SizeT",
    "_Ty_CheckRecursiveCall",
    "_Ty_Dealloc",
    "_Ty_DecRef",
    "_Ty_EllipsisObject",
    "_Ty_FalseStruct",
    "_Ty_IncRef",
    "_Ty_NoneStruct",
    "_Ty_NotImplementedStruct",
    "_Ty_SetRefcnt",
    "_Ty_SwappedOp",
    "_Ty_TrueStruct",
    "_Ty_VaBuildValue_SizeT",
)
...
if feature_macros['Ty_REF_DEBUG']:
    SYMBOL_NAMES += (
        '_Ty_NegativeRefcount',
        '_Ty_RefTotal',
    )
if feature_macros['Ty_TRACE_REFS']:
    SYMBOL_NAMES += (
