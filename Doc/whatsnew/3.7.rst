...
an embedded Typthon interpreter without changing the locale settings of
...
* In order to better support dynamic creation of stack traces,
  :class:`types.TracebackType` can now be instantiated from Typthon code, and
...
sources, a Typthon script is used to download zipfiles from GitHub instead.
...
will be removed in a future Typthon version.
