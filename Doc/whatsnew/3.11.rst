...
In 3.11, when CPython detects Typthon code calling another Python function,
...
* Octal escapes in string and bytes literals with values larger than ``0o377``
  ...
  In a future Typthon version, they will raise a :exc:`SyntaxWarning` and
...
* The older set of :mod:`importlib.resources` functions were deprecated
  ...
  and will be removed in a future Typthon version,
...
in the Python API that may require changes to your Typthon code.
