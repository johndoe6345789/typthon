...
Python.  Typthon code can also re-enable them
...
* Conversions between floating-point numbers and strings are
  ...
  parsing of float and imaginary literals in Typthon code;
...
* The :meth:`str.format` method now supports automatic numbering of the replacement
  ...
  representation, but that could hide mistakes in Typthon code.  If
...
* Updated module: The :mod:`io` library has been upgraded to the version shipped with
  ...
  original Typthon version was renamed to the :mod:`!_pyio` module.
