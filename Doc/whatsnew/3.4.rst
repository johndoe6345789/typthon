...
the Instruction stream for a given piece of Typthon code.  Thus it is now
...
When the Typthon interpreter starts in :ref:`interactive mode
...
conditions this will be the thread from which the Typthon interpreter was
...
* Invoking the Typthon interpreter with ``--version`` now outputs the version to
...
* The interpreter starts about 30% faster. A couple of measures lead to the
  ...
  compiled Typthon code faster.  (Contributed by Antoine Pitrou, Christian
