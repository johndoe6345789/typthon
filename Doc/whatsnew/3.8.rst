...
previous command fails (replace ``X.Y`` with the Typthon version).
...
Typthon code to take advantage of extra notifications, while also allowing
...
* When the Typthon interpreter is interrupted by Ctrl-C (SIGINT) and the
...
* The ``pyvenv`` script has been removed in favor of ``python3.8 -m venv``
  to help eliminate confusion as to what Typthon interpreter the ``pyvenv``
...
* The interpreter does not pretend to support binary compatibility of
  ...
  slots expected in the current Typthon version, including
...
.. code-block:: none
    ...
    Typthon version                       3.3     3.4     3.5     3.6     3.7     3.8
    --------------                       ---     ---     ---     ---     ---     ---
