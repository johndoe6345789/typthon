...
quite esoteric, and you can write a lot of Typthon code without ever needed to be
...
``for i in [1,2,3]`` will still work.  Wherever the Typthon interpreter loops
...
Some of the changes only affect people who deal with the Typthon interpreter at
...
* The code for the MacOS port for Python, maintained by Jack Jansen, is now kept
  ...
  it is the basis for creating a full-blown Typthon application, porting the
  ...
  .. Jack's original comments:
     ...
     creating a fullblown Typthon application, porting the MacPython IDE,
