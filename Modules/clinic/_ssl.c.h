...
TyDoc_STRVAR(_ssl__SSLSocket_do_handshake__doc__,
"do_handshake($self, /)\n"
"--\n"
"\n");
...
TyDoc_STRVAR(_ssl__test_decode_cert__doc__,
...
static TyObject *
_ssl__test_decode_cert(TyObject *module, TyObject *arg)
{
    TyObject *return_value = NULL;
    TyObject *path;

    if (!TyUnicode_FSConverter(arg, &path)) {
        goto exit;
    }
...
TyDoc_STRVAR(_ssl__SSLSocket_getpeercert__doc__,
...
static TyObject *
_ssl__SSLSocket_getpeercert(TyObject *self, TyObject *const *args, Ty_ssize_t nargs)
{
    TyObject *return_value = NULL;
    int binary_mode = 0;

    if (!_TyArg_CheckPositional("getpeercert", nargs, 0, 1)) {
        goto exit;
    }
    if (nargs < 1) {
        goto skip_optional;
...
TyDoc_STRVAR(_ssl__SSLSocket_get_verified_chain__doc__,
...
TyDoc_STRVAR(_ssl__SSLSocket_get_unverified_chain__doc__,
...
TyDoc_STRVAR(_ssl__SSLSocket_shared_ciphers__doc__,
"shared_ciphers($self, /)\n"
"--\n"
"\n");
...
TyDoc_STRVAR(_ssl__SSLSocket_cipher__doc__,
"cipher($self, /)\n"
"--\n"
"\n");
...
TyDoc_STRVAR(_ssl__SSLSocket_version__doc__,
"version($self, /)\n"
"--\n"
"\n");
...
TyDoc_STRVAR(_ssl__SSLSocket_selected_alpn_protocol__doc__,
...
TyDoc_STRVAR(_ssl__SSLSocket_compression__doc__,
"compression($self, /)\n"
"--\n"
"\n");
...
TyDoc_STRVAR(_ssl__SSLSocket_context__doc__,
...
TyDoc_STRVAR(_ssl__SSLSocket_server_side__doc__,
...
TyDoc_STRVAR(_ssl__SSLSocket_server_hostname__doc__,
...
TyDoc_STRVAR(_ssl__SSLSocket_owner__doc__,
...
TyDoc_STRVAR(_ssl__SSLSocket_write__doc__,
"write($self, b, /)\n"
"--\n"
"\n"
...
static TyObject *
_ssl__SSLSocket_write(TyObject *self, TyObject *arg)
{
    TyObject *return_value = NULL;
...
TyDoc_STRVAR(_ssl__SSLSocket_pending__doc__,
"pending($self, /)\n"
"--\n"
"\n"
...
TyDoc_STRVAR(_ssl__SSLSocket_read__doc__,
"read(size, [buffer])\n"
...
static TyObject *
_ssl__SSLSocket_read(TyObject *self, TyObject *args)
{
    TyObject *return_value = NULL;
    Ty_ssize_t len;
    int group_right_1 = 0;
    ...
    switch (TyTuple_GET_SIZE(args)) {
        case 1:
            if (!TyArg_ParseTuple(args, "n:read", &len)) {
                goto exit;
            }
            break;
        case 2:
            if (!TyArg_ParseTuple(args, "nw*:read", &len, &buffer)) {
                goto exit;
            }
            group_right_1 = 1;
            break;
        default:
            TyErr_SetString(TyExc_TypeError, "_ssl._SSLSocket.read requires 1 to 2 arguments");
            goto exit;
    }
    Ty_BEGIN_CRITICAL_SECTION(self);
...
TyDoc_STRVAR(_ssl__SSLSocket_shutdown__doc__,
"shutdown($self, /)\n"
"--\n"
"\n"
...
TyDoc_STRVAR(_ssl__SSLSocket_get_channel_binding__doc__,
...
static TyObject *
_ssl__SSLSocket_get_channel_binding(TyObject *self, TyObject *const *args, Ty_ssize_t nargs, TyObject *kwnames)
{
    TyObject *return_value = NULL;
    #if defined(Ty_BUILD_CORE) && !defined(Ty_BUILD_CORE_MODULE)
    ...
    if (!TyUnicode_Check(args[0])) {
        _TyArg_BadArgument("get_channel_binding", "argument 'cb_type'", "str", args[0]);
        goto exit;
    }
    Ty_ssize_t cb_type_length;
    cb_type = TyUnicode_AsUTF8AndSize(args[0], &cb_type_length);
    if (cb_type == NULL) {
        goto exit;
    }
...
TyDoc_STRVAR(_ssl__SSLSocket_verify_client_post_handshake__doc__,
...
TyDoc_STRVAR(_ssl__SSLSocket_session__doc__,
...
TyDoc_STRVAR(_ssl__SSLSocket_session_reused__doc__,
...
static TyObject *
_ssl__SSLContext(TyTypeObject *type, TyObject *args, TyObject *kwargs)
{
    TyObject *return_value = NULL;
    TyTypeObject *base_tp = get_state_type(type)->PySSLContext_Type;
    int proto_version;

    if ((type == base_tp || type->tp_init == base_tp->tp_init) &&
        !_TyArg_NoKeywords("_SSLContext", kwargs)) {
        goto exit;
    }
    if (!_TyArg_CheckPositional("_SSLContext", TyTuple_GET_SIZE(args), 1, 1)) {
        goto exit;
    }
    proto_version = TyLong_AsInt(TyTuple_GET_ITEM(args, 0));
    if (proto_version == -1 && TyErr_Occurred()) {
        goto exit;
    }
...
TyDoc_STRVAR(_ssl__SSLContext_set_ciphers__doc__,
...
static TyObject *
_ssl__SSLContext_set_ciphers(TyObject *self, TyObject *arg)
{
    TyObject *return_value = NULL;
    const char *cipherlist;

    if (!TyUnicode_Check(arg)) {
        _TyArg_BadArgument("set_ciphers", "argument", "str", arg);
        goto exit;
    }
    Ty_ssize_t cipherlist_length;
    cipherlist = TyUnicode_AsUTF8AndSize(arg, &cipherlist_length);
    if (cipherlist == NULL) {
        goto exit;
    }
...
TyDoc_STRVAR(_ssl__SSLContext_get_ciphers__doc__,
"get_ciphers($self, /)\n"
"--\n"
"\n");
...
TyDoc_STRVAR(_ssl__SSLContext__set_alpn_protocols__doc__,
...
static TyObject *
_ssl__SSLContext__set_alpn_protocols(TyObject *self, TyObject *arg)
{
    TyObject *return_value = NULL;
    Ty_buffer protos = {NULL, NULL};
...
TyDoc_STRVAR(_ssl__SSLContext_num_tickets__doc__,
...
TyDoc_STRVAR(_ssl__SSLContext_security_level__doc__,
...
TyDoc_STRVAR(_ssl__SSLContext_load_cert_chain__doc__,
...
static TyObject *
_ssl__SSLContext_load_cert_chain(TyObject *self, TyObject *const *args, Ty_ssize_t nargs, TyObject *kwnames)
{
    TyObject *return_value = NULL;
    #if defined(Ty_BUILD_CORE) && !defined(Ty_BUILD_CORE_MODULE)
    ...
    static struct {
        ...
        .ob_base = TyVarObject_HEAD_INIT(&TyTuple_Type, NUM_KEYWORDS)
        .ob_hash = -1,
        .ob_item = { &_Ty_ID(certfile), &_Ty_ID(keyfile), &_Ty_ID(password), },
    };
    #undef NUM_KEYWORDS
    #define KWTUPLE (&_kwtuple.ob_base.ob_base)
    ...
    TyObject *certfile;
    TyObject *keyfile = Ty_None;
    TyObject *password = Ty_None;
...
TyDoc_STRVAR(_ssl__SSLContext_load_verify_locations__doc__,
...
static TyObject *
_ssl__SSLContext_load_verify_locations(TyObject *self, TyObject *const *args, Ty_ssize_t nargs, TyObject *kwnames)
{
    TyObject *return_value = NULL;
    #if defined(Ty_BUILD_CORE) && !defined(Ty_BUILD_CORE_MODULE)
    ...
    static struct {
        ...
        .ob_base = TyVarObject_HEAD_INIT(&TyTuple_Type, NUM_KEYWORDS)
        .ob_hash = -1,
        .ob_item = { &_Ty_ID(cafile), &_Ty_ID(capath), &_Ty_ID(cadata), },
    };
    #undef NUM_KEYWORDS
    #define KWTUPLE (&_kwtuple.ob_base.ob_base)
    ...
    TyObject *argsbuf[3];
    Ty_ssize_t noptargs = nargs + (kwnames ? TyTuple_GET_SIZE(kwnames) : 0) - 0;
    TyObject *cafile = Ty_None;
    TyObject *capath = Ty_None;
    TyObject *cadata = Ty_None;
...
TyDoc_STRVAR(_ssl__SSLContext_load_dh_params__doc__,
...
static TyObject *
_ssl__SSLContext_load_dh_params(TyObject *self, TyObject *filepath)
{
    TyObject *return_value = NULL;
...
TyDoc_STRVAR(_ssl__SSLContext__wrap_socket__doc__,
...
static TyObject *
_ssl__SSLContext__wrap_socket(TyObject *self, TyObject *const *args, Ty_ssize_t nargs, TyObject *kwnames)
{
    TyObject *return_value = NULL;
    #if defined(Ty_BUILD_CORE) && !defined(Ty_BUILD_CORE_MODULE)
    ...
    static struct {
        ...
        .ob_base = TyVarObject_HEAD_INIT(&TyTuple_Type, NUM_KEYWORDS)
        .ob_hash = -1,
        .ob_item = { &_Ty_ID(sock), &_Ty_ID(server_side), &_Ty_ID(server_hostname), &_Ty_ID(owner), &_Ty_ID(session), },
    };
    #undef NUM_KEYWORDS
    #define KWTUPLE (&_kwtuple.ob_base.ob_base)
    ...
    TyObject *sock;
    int server_side;
    TyObject *hostname_obj = Ty_None;
    TyObject *owner = Ty_None;
    TyObject *session = Ty_None;
    ...
    if (!PyObject_TypeCheck(args[0], get_state_ctx(self)->Sock_Type)) {
        _TyArg_BadArgument("_wrap_socket", "argument 'sock'", (get_state_ctx(self)->Sock_Type)->tp_name, args[0]);
        goto exit;
    }
    sock = args[0];
...
TyDoc_STRVAR(_ssl__SSLContext__wrap_bio__doc__,
...
static TyObject *
_ssl__SSLContext__wrap_bio(TyObject *self, TyObject *const *args, Ty_ssize_t nargs, TyObject *kwnames)
{
    TyObject *return_value = NULL;
    #if defined(Ty_BUILD_CORE) && !defined(Ty_BUILD_CORE_MODULE)
    ...
    static struct {
        ...
        .ob_base = TyVarObject_HEAD_INIT(&TyTuple_Type, NUM_KEYWORDS)
        .ob_hash = -1,
        .ob_item = { &_Ty_ID(incoming), &_Ty_ID(outgoing), &_Ty_ID(server_side), &_Ty_ID(server_hostname), &_Ty_ID(owner), &_Ty_ID(session), },
    };
    #undef NUM_KEYWORDS
    #define KWTUPLE (&_kwtuple.ob_base.ob_base)
    ...
    if (!PyObject_TypeCheck(args[0], get_state_ctx(self)->PySSLMemoryBIO_Type)) {
        _TyArg_BadArgument("_wrap_bio", "argument 'incoming'", (get_state_ctx(self)->PySSLMemoryBIO_Type)->tp_name, args[0]);
        goto exit;
    }
    incoming = (PySSLMemoryBIO *)args[0];
    if (!PyObject_TypeCheck(args[1], get_state_ctx(self)->PySSLMemoryBIO_Type)) {
        _TyArg_BadArgument("_wrap_bio", "argument 'outgoing'", (get_state_ctx(self)->PySSLMemoryBIO_Type)->tp_name, args[1]);
        goto exit;
    }
...
TyDoc_STRVAR(_ssl__SSLContext_session_stats__doc__,
"session_stats($self, /)\n"
"--\n"
"\n");
...
TyDoc_STRVAR(_ssl__SSLContext_set_default_verify_paths__doc__,
...
TyDoc_STRVAR(_ssl__SSLContext_set_ecdh_curve__doc__,
...
static TyObject *
_ssl__SSLContext_set_ecdh_curve(TyObject *self, TyObject *name)
{
    TyObject *return_value = NULL;
...
TyDoc_STRVAR(_ssl__SSLContext_sni_callback__doc__,
...
TyDoc_STRVAR(_ssl__SSLContext_cert_store_stats__doc__,
...
TyDoc_STRVAR(_ssl__SSLContext_get_ca_certs__doc__,
...
static TyObject *
_ssl__SSLContext_get_ca_certs(TyObject *self, TyObject *const *args, Ty_ssize_t nargs, TyObject *kwnames)
{
    TyObject *return_value = NULL;
    #if defined(Ty_BUILD_CORE) && !defined(Ty_BUILD_CORE_MODULE)
...
TyDoc_STRVAR(_ssl__SSLContext_set_psk_client_callback__doc__,
...
static TyObject *
_ssl__SSLContext_set_psk_client_callback(TyObject *self, TyObject *const *args, Ty_ssize_t nargs, TyObject *kwnames)
{
    TyObject *return_value = NULL;
    #if defined(Ty_BUILD_CORE) && !defined(Ty_BUILD_CORE_MODULE)
...
TyDoc_STRVAR(_ssl__SSLContext_set_psk_server_callback__doc__,
...
static TyObject *
_ssl__SSLContext_set_psk_server_callback(TyObject *self, TyObject *const *args, Ty_ssize_t nargs, TyObject *kwnames)
{
    TyObject *return_value = NULL;
    #if defined(Ty_BUILD_CORE) && !defined(Ty_BUILD_CORE_MODULE)
    ...
    static struct {
        ...
        .ob_base = TyVarObject_HEAD_INIT(&TyTuple_Type, NUM_KEYWORDS)
        .ob_hash = -1,
        .ob_item = { &_Ty_ID(callback), &_Ty_ID(identity_hint), },
    };
    #undef NUM_KEYWORDS
    #define KWTUPLE (&_kwtuple.ob_base.ob_base)
    ...
    if (args[1] == Ty_None) {
        ...
        Ty_ssize_t identity_hint_length;
        identity_hint = TyUnicode_AsUTF8AndSize(args[1], &identity_hint_length);
        ...
        _TyArg_BadArgument("set_psk_server_callback", "argument 'identity_hint'", "str or None", args[1]);
        goto exit;
    }
skip_optional_pos:
    Ty_BEGIN_CRITICAL_SECTION(self);
...
static TyObject *
_ssl_MemoryBIO(TyTypeObject *type, TyObject *args, TyObject *kwargs)
{
    TyObject *return_value = NULL;
    TyTypeObject *base_tp = get_state_type(type)->PySSLMemoryBIO_Type;

    if ((type == base_tp || type->tp_init == base_tp->tp_init) &&
        !_TyArg_NoPositional("MemoryBIO", args)) {
        goto exit;
    }
    if ((type == base_tp || type->tp_init == base_tp->tp_init) &&
        !_TyArg_NoKeywords("MemoryBIO", kwargs)) {
        goto exit;
    }
    Ty_BEGIN_CRITICAL_SECTION(type);
...
TyDoc_STRVAR(_ssl_MemoryBIO_pending__doc__,
...
TyDoc_STRVAR(_ssl_MemoryBIO_eof__doc__,
...
TyDoc_STRVAR(_ssl_MemoryBIO_read__doc__,
"read($self, size=-1, /)\n"
"--\n"
"\n"
...
static TyObject *
_ssl_MemoryBIO_read(TyObject *self, TyObject *const *args, Ty_ssize_t nargs)
{
    TyObject *return_value = NULL;
    int len = -1;
    ...
    len = TyLong_AsInt(args[0]);
    if (len == -1 && TyErr_Occurred()) {
        goto exit;
    }
skip_optional:
    Ty_BEGIN_CRITICAL_SECTION(self);
...
TyDoc_STRVAR(_ssl_MemoryBIO_write__doc__,
"write($self, b, /)\n"
"--\n"
"\n"
...
static TyObject *
_ssl_MemoryBIO_write(TyObject *self, TyObject *arg)
{
    TyObject *return_value = NULL;
    Ty_buffer b = {NULL, NULL};
...
TyDoc_STRVAR(_ssl_MemoryBIO_write_eof__doc__,
"write_eof($self, /)\n"
"--\n"
"\n"
...
TyDoc_STRVAR(_ssl_SSLSession_time__doc__,
...
TyDoc_STRVAR(_ssl_SSLSession_timeout__doc__,
...
TyDoc_STRVAR(_ssl_SSLSession_ticket_lifetime_hint__doc__,
...
TyDoc_STRVAR(_ssl_SSLSession_id__doc__,
"Session ID.");
...
TyDoc_STRVAR(_ssl_RAND_add__doc__,
...
static TyObject *
_ssl_RAND_add(TyObject *module, TyObject *const *args, Ty_ssize_t nargs)
{
    TyObject *return_value = NULL;
    Ty_buffer view = {NULL, NULL};
    double entropy;

    if (!_TyArg_CheckPositional("RAND_add", nargs, 2, 2)) {
        goto exit;
    }
    if (TyUnicode_Check(args[0])) {
        Ty_ssize_t len;
    ...
    if (TyFloat_CheckExact(args[1])) {
        entropy = TyFloat_AS_DOUBLE(args[1]);
    }
    else
    {
        entropy = TyFloat_AsDouble(args[1]);
        if (entropy == -1.0 && TyErr_Occurred()) {
            goto exit;
        }
    }
...
TyDoc_STRVAR(_ssl_RAND_bytes__doc__,
"RAND_bytes($module, n, /)\n"
"--\n"
"\n"
...
static TyObject *
_ssl_RAND_bytes(TyObject *module, TyObject *arg)
{
    TyObject *return_value = NULL;
    int n;
...
TyDoc_STRVAR(_ssl_RAND_status__doc__,
"RAND_status($module, /)\n"
"--\n"
"\n"
...
TyDoc_STRVAR(_ssl_get_default_verify_paths__doc__,
...
TyDoc_STRVAR(_ssl_txt2obj__doc__,
...
static TyObject *
_ssl_txt2obj(TyObject *module, TyObject *const *args, Ty_ssize_t nargs, TyObject *kwnames)
{
    TyObject *return_value = NULL;
    #if defined(Ty_BUILD_CORE) && !defined(Ty_BUILD_CORE_MODULE)
    ...
    static struct {
        ...
        .ob_base = TyVarObject_HEAD_INIT(&TyTuple_Type, NUM_KEYWORDS)
        .ob_hash = -1,
        .ob_item = { &_Ty_ID(txt), &_Ty_ID(name), },
    };
    #undef NUM_KEYWORDS
    #define KWTUPLE (&_kwtuple.ob_base.ob_base)
    ...
    if (!TyUnicode_Check(args[0])) {
        _TyArg_BadArgument("txt2obj", "argument 'txt'", "str", args[0]);
        goto exit;
    }
    Ty_ssize_t txt_length;
    txt = TyUnicode_AsUTF8AndSize(args[0], &txt_length);
    if (txt == NULL) {
        goto exit;
    }
...
TyDoc_STRVAR(_ssl_nid2obj__doc__,
"nid2obj($module, nid, /)\n"
"--\n"
"\n"
...
static TyObject *
_ssl_nid2obj(TyObject *module, TyObject *arg)
{
    TyObject *return_value = NULL;
    int nid;

    nid = TyLong_AsInt(arg);
    if (nid == -1 && TyErr_Occurred()) {
        goto exit;
    }
    Ty_BEGIN_CRITICAL_SECTION(module);
...
TyDoc_STRVAR(_ssl_enum_certificates__doc__,
...
static TyObject *
_ssl_enum_certificates(TyObject *module, TyObject *const *args, Ty_ssize_t nargs, TyObject *kwnames)
{
    TyObject *return_value = NULL;
    #if defined(Ty_BUILD_CORE) && !defined(Ty_BUILD_CORE_MODULE)
    ...
    if (!TyUnicode_Check(args[0])) {
        _TyArg_BadArgument("enum_certificates", "argument 'store_name'", "str", args[0]);
        goto exit;
    }
    Ty_ssize_t store_name_length;
    store_name = TyUnicode_AsUTF8AndSize(args[0], &store_name_length);
    if (store_name == NULL) {
        goto exit;
    }
...
TyDoc_STRVAR(_ssl_enum_crls__doc__,
...
static TyObject *
_ssl_enum_crls(TyObject *module, TyObject *const *args, Ty_ssize_t nargs, TyObject *kwnames)
{
    TyObject *return_value = NULL;
    #if defined(Ty_BUILD_CORE) && !defined(Ty_BUILD_CORE_MODULE)
    ...
    if (!TyUnicode_Check(args[0])) {
        _TyArg_BadArgument("enum_crls", "argument 'store_name'", "str", args[0]);
        goto exit;
    }
    Ty_ssize_t store_name_length;
    store_name = TyUnicode_AsUTF8AndSize(args[0], &store_name_length);
