...
static TyObject *
make_heaptype_with_member(TyObject *module, TyObject *args, TyObject *kwargs)
{
    ...
    int member_flags = 0;
    int member_type = Ty_T_BYTE;

    if (!TyArg_ParseTupleAndKeywords(args, kwargs, "|iiip$sii:make_heaptype_with_member", _keywords,
