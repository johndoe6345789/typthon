...
#define TIER_TWO 2
        ...
        case _RESUME_CHECK: {
            ...
            _Py_emscripten_signal_clock -= Ty_EMSCRIPTEN_SIGNAL_HANDLING;
            #endif
        ...
        case _GUARD_BINARY_OP_EXTEND: {
            ...
            right = stack_pointer[-1];
            left = stack_pointer[-2];
            TyObject *descr = (TyObject *)CURRENT_OPERAND0();
            TyObject *left_o = PyStackRef_AsPyObjectBorrow(left);
            TyObject *right_o = PyStackRef_AsPyObjectBorrow(right);
        ...
        case _LOAD_ATTR_WITH_HINT: {
            ...
            #ifdef Ty_GIL_DISABLED
            if (!_Py_IsOwnedByCurrentThread((TyObject *)dict) && !_TyObject_GC_IS_SHARED(dict)) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            #endif
        ...
        case _LOAD_ATTR_PROPERTY_FRAME: {
            ...
            oparg = CURRENT_OPARG();
            owner = stack_pointer[-1];
            TyObject *fget = (TyObject *)CURRENT_OPERAND0();
            assert((oparg & 1) == 0);
        ...
        case _ITER_NEXT_LIST_TIER_TWO: {
            ...
            assert(_Py_IsOwnedByCurrentThread((TyObject *)seq) ||
        ...
        case _GUARD_NOT_EXHAUSTED_TUPLE: {
            ...
            if (it->it_index >= TyTuple_GET_SIZE(seq)) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            break;
        ...
        case _LOAD_SPECIAL: {
            ...
            TyObject *name = _Py_SpecialMethods[oparg].name;
            _TyFrame_SetStackPointer(frame, stack_pointer);
        ...
        case _CHECK_FUNCTION_VERSION_INLINE: {
            uint32_t func_version = (uint32_t)CURRENT_OPERAND0();
            TyObject *callable_o = (TyObject *)CURRENT_OPERAND1();
        ...
        case _CHECK_AND_ALLOCATE_OBJECT: {
            ...
            if (!_TyThreadState_HasStackSpace(tstate, code->co_framesize + _Py_InitCleanup.co_framesize)) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            STAT_INC(CALL, hit);
        ...
        case _CHECK_STACK_SPACE_OPERAND: {
            ...
            if (!_TyThreadState_HasStackSpace(tstate, framesize)) {
                UOP_STAT_INC(uopcode, miss);
                JUMP_TO_JUMP_TARGET();
            }
            if (tstate->py_recursion_remaining <= 1) {
        ...
        case _LOAD_CONST_INLINE: {
            _PyStackRef value;
            TyObject *ptr = (TyObject *)CURRENT_OPERAND0();
        ...
        case _START_EXECUTOR: {
            TyObject *executor = (TyObject *)CURRENT_OPERAND0();
            #ifndef _Py_JIT
