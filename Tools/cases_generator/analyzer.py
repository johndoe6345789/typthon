...
NON_ESCAPING_FUNCTIONS = (
    ...
    "_Ty_DECREF_NO_DEALLOC",
    "_Ty_ID",
    "_Ty_IsImmortal",
    "_Ty_IsOwnedByCurrentThread",
    "_Ty_LeaveRecursiveCallPy",
    "_Ty_LeaveRecursiveCallTstate",
    "_Ty_NewRef",
    "_Ty_SINGLETON",
    "_Ty_STR",
    "_Ty_TryIncrefCompare",
    "_Ty_TryIncrefCompareStackRef",
    "_Ty_atomic_compare_exchange_uint8",
    "_Ty_atomic_load_ptr_acquire",
    "_Ty_atomic_load_uintptr_relaxed",
    "_Ty_set_eval_breaker_bit",
